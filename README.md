...
Note (not explained in the video): the select menu for users is dynamically populated by sending a request to the web server which queries for all the user name entries in the database.
